 ...
 * 
 * Clase ReservaVo
 * Genera un VO de Reserva con los datos de Reserva, constructor con parámetros, 
...
public class ReservaVo {
	...
	public static ReservaVo fromORM(orm.Reserva r) {
		ReservaVo re = new ReservaVo(r.getId(), PersonaVo.fromORM(r
				.getPersona()), PacienteVo.fromORM(r.getPaciente()));
		return re;
	}
