...
public class Hospitaldb2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Hospitaldb2";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Hospitaldb2PersistentManager();
		}
