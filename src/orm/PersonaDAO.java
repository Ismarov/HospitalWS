...
public class PersonaDAO {
	...
	public static boolean save(orm.Persona persona) throws PersistentException {
		try {
			orm.Hospitaldb2PersistentManager.instance().saveObject(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Persona persona) throws PersistentException {
		try {
			orm.Hospitaldb2PersistentManager.instance().deleteObject(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Persona persona)throws PersistentException {
		try {
			if(persona.getPaciente() != null) {
				persona.getPaciente().setPersona(null);
			}
	...
	public static boolean refresh(orm.Persona persona) throws PersistentException {
		try {
			orm.Hospitaldb2PersistentManager.instance().getSession().refresh(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Persona persona) throws PersistentException {
		try {
			orm.Hospitaldb2PersistentManager.instance().getSession().evict(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
